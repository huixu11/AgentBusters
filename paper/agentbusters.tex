...
\subsubsection{PRBench (Knowledge Retrieval)}
Professional reasoning questions derived from Scale AI's PRBench \citep{prbench2025}:
\begin{itemize}
    \item \textbf{Complex Reasoning}: Multi-step professional financial reasoning tasks
    \item \textbf{Domain Expertise}: Questions requiring deep financial domain knowledge
\end{itemize}
...
\begin{itemize}
    \item \textbf{Knowledge Retrieval}: BizFinBench v2 + PRBench (financial facts, professional reasoning)
...
\bibitem[Aky\"{u}rek et al.(2025)]{prbench2025}
Aky\"{u}rek, A.~F., Gosai, A., Zhang, C.~B.~C., et al. (2025).
\newblock PRBench: Large-Scale Expert Rubrics for Evaluating High-Stakes Professional Reasoning.
\newblock \emph{arXiv preprint arXiv:2511.11562}.
\newblock \url{https://arxiv.org/abs/2511.11562}.
